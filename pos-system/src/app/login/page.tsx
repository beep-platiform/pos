    ...
    try {
      if (mode === "login") {
        ...
        if (!data.session) {
          ...
          // Don't navigate anywhere that needs auth — just tell the user to check their inbox.
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        <div className="w-full max-w-sm bg-surface rounded-2xl shadow-sm border border-border p-8 text-center">
          <div className="h-10 w-10 rounded-full bg-primary flex items-center justify-center text-white mx-auto mb-4">
          ...
          <p className="text-sm text-muted mb-4">
            ...
            then come back and log in below.
          </p>
          <button
            onClick={() => {
